...
import com.example.spring_ai_basics.service.RagService
...
class AiController(
    private val simpleAiService: SimpleAiService,
    ...
    @GetMapping("/ask")
    fun askQuestion(@RequestParam query: String): String {
        return ragService.generateAnswer(query) ?: "Sorry, could not generate an answer."
    }
}